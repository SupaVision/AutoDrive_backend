...
def transform_to_frame(
    params: dict, time_idx: int, gaussians_grad: bool, camera_grad: bool
) -> dict:
    """
...
def transformed_params2depthplussilhouette(
    params: dict, w2c: torch.Tensor, transformed_gaussians: dict
) -> dict:
    """
